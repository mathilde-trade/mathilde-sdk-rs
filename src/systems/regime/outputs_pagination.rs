...
impl<'a> RangeCall<'a> {
    pub(crate) fn new(client: &'a Regime, request: RangeRequest) -> Self {
        Self { client, request }
    }
...
impl<'a> RangeGrpcCall<'a> {
    pub(crate) fn new(client: &'a Regime, request: RangeGrpcRequest) -> Self {
        Self { client, request }
    }
...
impl<'a> SearchCall<'a> {
    pub(crate) fn new(client: &'a Regime, request: SearchRequest) -> Self {
        Self { client, request }
    }
...
impl<'a> SearchGrpcCall<'a> {
    pub(crate) fn new(client: &'a Regime, request: SearchGrpcRequest) -> Self {
        Self { client, request }
    }
...
impl<'a> TimeMachineCall<'a> {
    pub(crate) fn new(client: &'a Regime, request: TimeMachineRequest) -> Self {
        Self { client, request }
    }
...
impl<'a> TimeMachineGrpcCall<'a> {
    pub(crate) fn new(client: &'a Regime, request: TimeMachineGrpcRequest) -> Self {
        Self { client, request }
    }
...
impl<'a> RangePager<'a> {
    fn new(client: &'a Regime, request: RangeRequest) -> Self {
        Self {
            client,
            request,
...
impl<'a> RangeGrpcPager<'a> {
    fn new(client: &'a Regime, request: RangeGrpcRequest) -> Self {
        Self {
            client,
            request,
            state: PaginationState::new(),
...
impl<'a> SearchPager<'a> {
    fn new(client: &'a Regime, request: SearchRequest) -> Self {
        Self {
            client,
            request,
            state: PaginationState::new(),
...
impl<'a> SearchGrpcPager<'a> {
    fn new(client: &'a Regime, request: SearchGrpcRequest) -> Self {
        Self {
            client,
            request,
            state: PaginationState::new(),
...
impl<'a> TimeMachinePager<'a> {
    fn new(client: &'a Regime, request: TimeMachineRequest) -> Self {
        Self {
            client,
            request,
            state: PaginationState::new(),
...
impl<'a> TimeMachineGrpcPager<'a> {
    fn new(client: &'a Regime, request: TimeMachineGrpcRequest) -> Self {
        Self {
            client,
            request,
            state: PaginationState::new(),

...
use crate::systems::regime::client::Regime;
...
impl<'a> RangeOutputsCall<'a> {
    pub(crate) fn new(client: &'a Regime, request: RangeOutputsRequest) -> Self {
        Self { client, request }
    }
...
impl<'a> RangeOutputsGrpcCall<'a> {
    pub(crate) fn new(client: &'a Regime, request: RangeOutputsGrpcRequest) -> Self {
        Self { client, request }
    }
...
impl<'a> SearchOutputsCall<'a> {
    pub(crate) fn new(client: &'a Regime, request: SearchOutputsRequest) -> Self {
        Self { client, request }
    }
...
impl<'a> SearchOutputsGrpcCall<'a> {
    pub(crate) fn new(client: &'a Regime, request: SearchOutputsGrpcRequest) -> Self {
        Self { client, request }
    }
...
impl<'a> TimeMachineOutputsCall<'a> {
    pub(crate) fn new(client: &'a Regime, request: TimeMachineOutputsRequest) -> Self {
        Self { client, request }
    }
...
impl<'a> TimeMachineOutputsGrpcCall<'a> {
    pub(crate) fn new(client: &'a Regime, request: TimeMachineOutputsGrpcRequest) -> Self {
        Self { client, request }
    }
...
impl<'a> RangeOutputsPager<'a> {
    fn new(client: &'a Regime, request: RangeOutputsRequest) -> Self {
        Self {
            client,
            request,
...
impl<'a> RangeOutputsGrpcPager<'a> {
    fn new(client: &'a Regime, request: RangeOutputsGrpcRequest) -> Self {
        Self {
            client,
            request,
            state: PaginationState::new(),
...
impl<'a> SearchOutputsPager<'a> {
    fn new(client: &'a Regime, request: SearchOutputsRequest) -> Self {
        Self {
            client,
            request,
            state: PaginationState::new(),
...
impl<'a> SearchOutputsGrpcPager<'a> {
    fn new(client: &'a Regime, request: SearchOutputsGrpcRequest) -> Self {
        Self {
            client,
            request,
            state: PaginationState::new(),
...
impl<'a> TimeMachineOutputsPager<'a> {
    fn new(client: &'a Regime, request: TimeMachineOutputsRequest) -> Self {
        Self {
            client,
            request,
            state: PaginationState::new(),
...
impl<'a> TimeMachineOutputsGrpcPager<'a> {
    fn new(client: &'a Regime, request: TimeMachineOutputsGrpcRequest) -> Self {
        Self {
            client,
            request,
            state: PaginationState::new(),

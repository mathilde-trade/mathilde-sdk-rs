...
use crate::systems::primitives::{PrimitiveOutput, Primitives, RangeOutputsGrpcRequest};
...
#[tokio::test]
async fn test_range_outputs_grpc_uses_unary_path_and_decodes_with_meta_response() {
    ...
    assert_eq!(captured.body.pairs, vec!["BTCUSDT"]);
    ...
    assert_eq!(captured.body.close_end_ms, 1770000060000);
